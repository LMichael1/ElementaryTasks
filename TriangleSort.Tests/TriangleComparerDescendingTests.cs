...
{
    public class TrinagleComparerDescendingTests : IClassFixture<TriangleComparerDescending>
    {
        #region fields

        private TriangleComparerDescending _comparer; 

        #endregion

        public TrinagleComparerDescendingTests()
        {
            _comparer = new TriangleComparerDescending();
        }
        ...
        public void Compare_WithTriangles_ShouldReturnEqual(string name1, double firstSide1, double secondSide1, double thirdSide1,
        ...
        public void Compare_WithTriangles_ShouldReturnLess(string name1, double firstSide1, double secondSide1, double thirdSide1,
            string name2, double firstSide2, double secondSide2, double thirdSide2)
        {
            Triangle first = new Triangle(name1, firstSide1, secondSide1, thirdSide1);
            Triangle second = new Triangle(name2, firstSide2, secondSide2, thirdSide2);

            Assert.Equal(1, _comparer.Compare(first, second));
        }
        ...
        public void Compare_WithTriangles_ShouldReturnBigger(string name1, double firstSide1, double secondSide1, double thirdSide1,
            string name2, double firstSide2, double secondSide2, double thirdSide2)
        {
            Triangle first = new Triangle(name1, firstSide1, secondSide1, thirdSide1);
            Triangle second = new Triangle(name2, firstSide2, secondSide2, thirdSide2);
